...
<head>
    ...
    <style>
        #grad {
            background: -webkit-linear-gradient(left,rgba(255,0,0,0),rgba(180,180,180,1)); /* Safari 5.1 - 6 */
            background: -o-linear-gradient(right,rgba(255,0,0,0),rgba(180,180,180,1)); /* Opera 11.1 - 12*/
            background: -moz-linear-gradient(right,rgba(255,0,0,0),rgba(180,180,180,1)); /* Firefox 3.6 - 15*/
            background: linear-gradient(to right, rgba(255,0,0,0), rgba(180,180,180,1)); /* 标准的语法 */
        }
    </style>
</head>
...
<!---------- 主体内容 ---------->
<div id="main">
    <div class="auto-width clearfix" style="background-color: cornflowerblue;">
            <table align="center" border="2" id="grad">
                <tr>
                    <th>标题</th>
                    <th>类型</th>
                    <th>封面</th>
                ...
                <s:iterator value="#request.list" var="video">
                    <tr>
                        <td><s:property value="#video.title"/></td>
                        <td><s:property value="#video.type"/></td>
                        <td><img src="<%=basePath%><s:property value="#video.cover"/>" alt="#"/></td>
                        <td><a href="<%=basePath%>VideoManager_Delete?videoNumber=<s:property value="#video.videoNumber"/>">删除</a></td>
                    </tr>
                </s:iterator>
            </table>
    </div>
