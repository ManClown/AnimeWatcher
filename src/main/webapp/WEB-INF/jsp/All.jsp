...
<div id="header">
  ...
  <div class="header-nav">
    <div class="nav-wrap auto-width clearfix">
      ...
      <a href="<%=basePath%>BooldVideoAction" class="nav-item">热血</a>
      <a href="<%=basePath%>YouthVideoAction" class="nav-item">青春</a>
      <a href="<%=basePath%>CampusVideoAction" class="nav-item">校园</a>
      <a href="<%=basePath%>SportsVideoAction" class="nav-item">运动</a>
      <a href="<%=basePath%>GameVideoAction" class="nav-item">竞技</a>
      <a href="<%=basePath%>ParentkidVideoAction" class="nav-item">亲子</a>
      <a href="<%=basePath%>HaremVideoAction" class="nav-item">后宫</a>
      <a href="<%=basePath%>WarVideoAction" class="nav-item">战争</a>
      <a href="<%=basePath%>RomanticVideoAction" class="nav-item">恋爱</a>
      <a href="<%=basePath%>MagicVideoAction" class="nav-item">魔幻</a>
      <a href="<%=basePath%>AdventureVideoAction" class="nav-item">冒险</a>
      <a href="<%=basePath%>ResoningVideoAction" class="nav-item">推理</a>
    </div>
  </div>
          ...
          <ul class="area-menu clearfix">
            <s:iterator value="#request.display" var="video" status="vd">
              <li class="area-menu__item">
                ...
                <div class="info">
                  <a href="<%=basePath%>PlayerAction?videoNumber=<s:property value="#video.videoNumber"/>"
                     class="change-title"> <s:property value="#video.title"/> </a>
...
<script>
    function goto() {
        ...
        window.location.href = "<%=basePath%>AllVideoAction?page="+page.value;
    }
</script>
