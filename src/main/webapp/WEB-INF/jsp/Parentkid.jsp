...
<div id="header">
    ...
    <div class="header-nav">
        <div class="nav-wrap auto-width clearfix">
            <a href="<%=basePath%>AllVideoAction" class="nav-item">全部</a>
            ...
            <a href="<%=basePath%>ParentkidVideoAction" class="nav-item nav-cur">亲子</a>
...
<script>
    function goto() {
        ...
        window.location.href = "<%=basePath%>ParentkidVideoAction?page="+page.value;
    }
</script>
